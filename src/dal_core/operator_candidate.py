...
def build_operator_candidates(
    ...
    total_sources_count = len(trigger.sources)
    ...
    for lookup_result in lookup_results:
        ...
        if not matched_entries:
            ...
            candidate_set_residuals.extend(lookup_result.lookup_residuals)
        ...
        matching_sources = [
            src for src in trigger.sources if src.family == family
        ]
